#ifndef __VIBUFFER_GOALPARTICLETEX_H__
#define __VIBUFFER_GOALPARTICLETEX_H__

#include "VIBuffer.h"

BEGIN(Engine)

class ENGINE_DLL CVIBuffer_GoalParticleTex : public CVIBuffer
{
public:
	typedef struct
	{
...
private:
	explicit CVIBuffer_GoalParticleTex(LPDIRECT3DDEVICE9 pGraphicDev);
	explicit CVIBuffer_GoalParticleTex(const CVIBuffer_GoalParticleTex& rhs);
	virtual ~CVIBuffer_GoalParticleTex(void);
...
public:
	static CVIBuffer_GoalParticleTex*	Create(LPDIRECT3DDEVICE9 pGraphicDev);
...
#endif // __VIBUFFER_GOALPARTICLETEX_H__