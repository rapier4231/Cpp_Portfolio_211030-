...
Engine::CVIBuffer_BloodParticleTex::CVIBuffer_BloodParticleTex(LPDIRECT3DDEVICE9 pGraphicDev)
...
Engine::CVIBuffer_BloodParticleTex::CVIBuffer_BloodParticleTex(const CVIBuffer_BloodParticleTex& rhs)
	: CVIBuffer(rhs)
{
...
Engine::CVIBuffer_BloodParticleTex::~CVIBuffer_BloodParticleTex(void)
{

}

HRESULT CVIBuffer_BloodParticleTex::Ready_Component_Prototype()
{
	return S_OK;
}

HRESULT CVIBuffer_BloodParticleTex::Ready_Component(void * pArg)
{
	return S_OK;
}

HRESULT CVIBuffer_BloodParticleTex::Render_VIBuffer()
{
	if (!m_bAni)
		return S_OK;
...
_int CVIBuffer_BloodParticleTex::Update_Particle(_float _fTimeDelta)
{
	if (!m_bAni)
		return 0;
	...
	for (_int i = 0; i < m_iParticleCount; ++i)
	{
		...
		int			_iIndexX = (_int)(pPrt->m_fImageIndex) % (_int)m_fImageWidth;
		int			_iIndexY = (_int)(pPrt->m_fImageIndex / m_fImageHeight);

		D3DXVECTOR2	uv00((_iIndexX + 0) / m_fImageWidth, (_iIndexY + 0) / m_fImageHeight);
		D3DXVECTOR2	uv11((_iIndexX + 1) / m_fImageWidth, (_iIndexY + 1) / m_fImageHeight);
...
void CVIBuffer_BloodParticleTex::SetAni(BOOL bAni)
{
	m_bAni = bAni;
...
void CVIBuffer_BloodParticleTex::SetAvgTime(_float _fTime)
{
	m_fTimeAvg = _fTime;
}

void CVIBuffer_BloodParticleTex::SetPart(_int _iIndex)
{
...
CVIBuffer_BloodParticleTex* Engine::CVIBuffer_BloodParticleTex::Create(LPDIRECT3DDEVICE9 pGraphicDev)
{
	CVIBuffer_BloodParticleTex*	pInstance = new CVIBuffer_BloodParticleTex(pGraphicDev);
...
CComponent * CVIBuffer_BloodParticleTex::Clone(void * pArg)
{
	CVIBuffer_BloodParticleTex* pClone = new CVIBuffer_BloodParticleTex(*this);
...
void Engine::CVIBuffer_BloodParticleTex::Free(void)
{
	if (m_bIsClone)
	{
