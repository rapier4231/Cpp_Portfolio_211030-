#pragma once
#ifndef __MonsterStat_UI_Bar_H__
#define __MonsterStat_UI_Bar_H__
...
class CMonsterStat_UI_Bar : public COrthoUI
{
private:
	typedef struct stMonsterStat_UI_Bar_Resolution_Info : STOURI
	{
...
private:
	explicit CMonsterStat_UI_Bar(LPDIRECT3DDEVICE9 _pDevice);
	explicit CMonsterStat_UI_Bar(const CMonsterStat_UI_Bar& rhs);
	virtual ~CMonsterStat_UI_Bar() = default;
...
public:
	static	CMonsterStat_UI_Bar*   Create(LPDIRECT3DDEVICE9 _pDevice);
...
private:
	...
	CUI*					m_pBackMonsterStat_UI = nullptr;

private:
	EMonsterSTATbar			m_eStatType = EMonsterSTATbar_End;
...
#endif // !__MonsterStat_UI_Bar_H__