#pragma once
#ifndef __StructureStat_UI_Bar_H__
#define __StructureStat_UI_Bar_H__
...
class CStructureStat_UI_Bar : public COrthoUI
{
private:
	typedef struct stStructureStat_UI_Bar_Resolution_Info : STOURI
	{
		_float fPosX[ESNRT_END] = { WINCX*FHALF - 0.07f*ScrnRatio, WINCX*FHALF - 0.2f*ScrnRatio };
		_float fPosY[ESNRT_END] = { 1.39f*ScrnRatio , 4.2f*ScrnRatio };
		...
		_vec4  v4Amount_Bar_EdgeSize[ESNRT_END] = { { 0.006f, 0.06f ,0.9f ,0.93f },{ 0.006f, 0.04f ,0.995f ,0.96f } };
		_vec4  v4Amount_Plus_EdgeSize[ESNRT_END] = { { 0.006f, 0.02f ,0.99f ,0.93f },{ 0.05f, 0.06f ,0.99f ,0.93f } };
		...
		_float fFont_Amount_Stat_IntervalPosX[ESNRT_END] = { 0.41f*ScrnRatio ,1.6f*ScrnRatio };
		_float fFont_Amount_Stat_IntervalPosY[ESNRT_END] = { 0.025f*ScrnRatio ,0.07f*ScrnRatio };
...
private:
	explicit CStructureStat_UI_Bar(LPDIRECT3DDEVICE9 _pDevice);
	explicit CStructureStat_UI_Bar(const CStructureStat_UI_Bar& rhs);
	virtual ~CStructureStat_UI_Bar() = default;
...
public:
	static	CStructureStat_UI_Bar*   Create(LPDIRECT3DDEVICE9 _pDevice);
...
private:
	...
	CUI*					m_pBackStructureStat_UI = nullptr;

private:
	EStructureSTATbar		m_eStatType = EStructureSTATbar_End;
...
#endif // !__StructureStat_UI_Bar_H__