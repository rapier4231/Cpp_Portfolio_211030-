...
CBloodParticle::CBloodParticle(LPDIRECT3DDEVICE9 _pDevice)
...
HRESULT CBloodParticle::Ready_GameObject_Prototype()
{
...
HRESULT CBloodParticle::Ready_GameObject(void * _pArg/* = nullptr*/)
{
...
_int CBloodParticle::Update_GameObject(const _double & _dTimeDelta)
{
	if (0.f > m_fAlpha)
		Set_Dead();
	...
	//if(8 < m_dCount)
		m_fAlpha -= (_float)_dTimeDelta * 1.5f /* 1.f / (m_iTextureX * m_iTextureY)*/;

	m_pBufferCom->SetAvgTime(10.f);
...
_int CBloodParticle::LateUpdate_GameObject(const _double & _dTimeDelta)
{
...
void CBloodParticle::Render_GameObject()
{
	if (!m_bUpdated)
		return;
...
CBloodParticle * CBloodParticle::Create(LPDIRECT3DDEVICE9 _pDevice)
{
	CBloodParticle*	pInstance = new CBloodParticle(_pDevice);
...
CGameObject * CBloodParticle::Clone(void * _pArg/* = nullptr*/)
{
	CBloodParticle*	pClone = new CBloodParticle(*this);
...
HRESULT CBloodParticle::Add_Component(void)
{
	CComponent*		pComponent = nullptr;

	pComponent = m_pBufferCom = dynamic_cast<CVIBuffer_BloodParticleTex*>(Engine::Clone_ComponentPrototype(L"Proto_Com_VIBuffer_BloodParticleTex"));
...
HRESULT CBloodParticle::SetUp_ConstantTable(LPD3DXEFFECT & _pEffect)
{
