#include "stdafx.h"
#include "..\Headers\InvenDropAll.h"

#include "Export_Function.h"

//#define ICON_DropAllPOSX	-5.f   -
//#define ICON_DropAllPOSY	-180.f -
 
USING(Engine)

HRESULT CInvenDropAll::Set_Screen_UI()
{
...
CInvenDropAll::CInvenDropAll(LPDIRECT3DDEVICE9 _pDevice)
	: CInvenIcon(_pDevice)
{
}

CInvenDropAll::CInvenDropAll(const CInvenDropAll & rhs)
	: CInvenIcon(rhs)
{
}

HRESULT CInvenDropAll::Ready_GameObject_Prototype()
{
...
HRESULT CInvenDropAll::Ready_GameObject(void * _pArg/* = nullptr*/)
{
...
_int CInvenDropAll::Update_GameObject(const _double & _dTimeDelta)
{
	CInvenIcon::Update_GameObject(_dTimeDelta);
	return S_OK;
}

_int CInvenDropAll::LateUpdate_GameObject(const _double & _dTimeDelta)
{
...
void CInvenDropAll::Render_GameObject(_mat _matOrtho)
{
	if (!m_tORTHOUI_INFO.bRender)
		return;
...
CInvenDropAll * CInvenDropAll::Create(LPDIRECT3DDEVICE9 _pDevice)
{
	CInvenDropAll*	pInstance = new CInvenDropAll(_pDevice);
...
CUI * CInvenDropAll::Clone(void * _pArg/* = nullptr*/)
{
	CInvenDropAll*	pClone = new CInvenDropAll(*this);
...
HRESULT CInvenDropAll::Add_Component(void)
{
	CComponent*		pComponent = nullptr;

	pComponent = m_pTextureCom = static_cast<CTexture*>(Engine::Clone_ComponentPrototype(L"Proto_Texture_InvenIcon_DropAll"));
...
HRESULT CInvenDropAll::SetUp_ConstantTable(LPD3DXEFFECT & _pEffect, _mat _matOrtho)
{
