#include "stdafx.h"
#include "..\Headers\InvenFolder.h"

#include "Export_Function.h"

//#define ICON_FolderPOSX	35.f
//#define ICON_FolderPOSY	-180.f

USING(Engine)

HRESULT CInvenFolder::Set_Screen_UI()
{
...
CInvenFolder::CInvenFolder(LPDIRECT3DDEVICE9 _pDevice)
	: CInvenIcon(_pDevice)
{
}

CInvenFolder::CInvenFolder(const CInvenFolder & rhs)
	: CInvenIcon(rhs)
{
}

HRESULT CInvenFolder::Ready_GameObject_Prototype()
{
...
HRESULT CInvenFolder::Ready_GameObject(void * _pArg/* = nullptr*/)
{
...
_int CInvenFolder::Update_GameObject(const _double & _dTimeDelta)
{
...
_int CInvenFolder::LateUpdate_GameObject(const _double & _dTimeDelta)
{
...
void CInvenFolder::Render_GameObject(_mat _matOrtho)
{
	if (!m_tORTHOUI_INFO.bRender)
		return;
...
CInvenFolder * CInvenFolder::Create(LPDIRECT3DDEVICE9 _pDevice)
{
	CInvenFolder*	pInstance = new CInvenFolder(_pDevice);
...
CUI * CInvenFolder::Clone(void * _pArg/* = nullptr*/)
{
	CInvenFolder*	pClone = new CInvenFolder(*this);
...
HRESULT CInvenFolder::Add_Component(void)
{
	CComponent*		pComponent = nullptr;

	pComponent = m_pTextureCom = static_cast<CTexture*>(Engine::Clone_ComponentPrototype(L"Proto_Texture_InvenIcon_Folder"));
...
HRESULT CInvenFolder::SetUp_ConstantTable(LPD3DXEFFECT & _pEffect, _mat _matOrtho)
{
