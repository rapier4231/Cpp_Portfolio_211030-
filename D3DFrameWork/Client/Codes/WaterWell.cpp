...
CWaterWell::CWaterWell(LPDIRECT3DDEVICE9 _pDevice)
	: CStructure(_pDevice)
{
}

CWaterWell::CWaterWell(const CWaterWell & _rhs)
	: CStructure(_rhs)
{
}

HRESULT CWaterWell::Ready_GameObject_Prototype()
{
...
HRESULT CWaterWell::Ready_GameObject(void * _pArg)
{
...
_int CWaterWell::Update_GameObject(const _double & _dTimeDelta)
{
...
_int CWaterWell::LateUpdate_GameObject(const _double & _dTimeDelta)
{
...
void CWaterWell::Render_GameObject()
{
	CStructure::Render_GameObject();
}

CWaterWell * CWaterWell::Create(LPDIRECT3DDEVICE9 _pDevice)
{
	CWaterWell*	pInstance = new CWaterWell(_pDevice);
...
CGameObject * CWaterWell::Clone(void * _pArg)
{
	CWaterWell*	pClone = new CWaterWell(*this);
...
HRESULT CWaterWell::Add_Component()
{
	CComponent*		pComponent = nullptr;

	/// 매쉬 컴포넌트
	pComponent = m_pMeshCom = static_cast<CStaticMesh*>(Engine::Clone_ComponentPrototype(L"Proto_StaticMesh_Structure_WaterWell"));
